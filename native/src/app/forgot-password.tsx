    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Text className="mb-1 text-2xl font-semibold text-white">Reset Password</Text>
                    ...
                    {error && (
                        ...
                        >
                            <Feather
                                ...
                                className="mr-3"
                            />
                            <Text className="flex-1 text-sm font-medium text-red-400">{error}</Text>
                        </Animated.View>
                    )}
                    ...
                    <View className="mt-6 flex-row items-center justify-center gap-4">
                        ...
                        <Pressable
                            ...
                            className="flex-row items-center"
                        >
                            <Text className="text-sm font-semibold text-amber-400">Register</Text>
                        </Pressable>
                    </View>
                </Animated.View>
            </ScrollView>
